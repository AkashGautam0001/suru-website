    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        ...
        <button
          ...
          className="inline-flex items-center gap-3 text-white font-medium transition-all duration-300 hover:-translate-y-1 hover:brightness-110 border-none cursor-pointer"
          style={{
            background: "#2b2b2b",
            borderRadius: "999px",
        ...
        >
          ...
          Quick Connect
          <ArrowUpRight style={{ width: "clamp(16px, 1.8vw, 20px)", height: "clamp(16px, 1.8vw, 20px)" }} />
        </button>

        {/* Email Button */}
        <button
          onClick={handleEmail}
          className="inline-flex items-center gap-3 font-medium transition-all duration-300 hover:-translate-y-1 border-none cursor-pointer"
          style={{
