        ...
        <div className="relative z-10 max-w-4xl w-full pt-24 flex flex-col items-center">
          ...
          <div className="flex flex-col items-center gap-3">
            <a
              ...
              className="inline-flex items-center gap-3 text-white font-semibold transition-all duration-300 hover:scale-105 hover:brightness-110 text-base sm:text-lg no-underline"
              style={{
                background: "#00c57e",
                borderRadius: "999px",
                padding: "16px 36px",
                boxShadow: "0 8px 32px rgba(0,197,126,0.35)",
              }}
            >
              {/* WhatsApp Icon */}
              <svg
