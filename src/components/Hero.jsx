...
import swoosh from "../assets/icons/spring.png";
...
function SwooshToCta({ className = "" }) {
  return (
    ...
    //   />
    //   <path d="M52 12c-8 14-22 24-40 28" stroke="#8ad4f0" strokeWidth="1.75" strokeLinecap="round" opacity="0.85" />
    // </svg>
    <img src={swoosh} alt="Swoosh" className={className} width={72} height={56} />
  );
}
      ...
      <section
        ...
        <div className="relative z-10 content-area flex flex-col items-center">
          ...
          <p className="mb-2 text-base font-medium text-[#5c5c5c] sm:text-lg">
            Adoption <span style={{ color: PINK_SOFT }}>•</span> Retention <span style={{ color: PINK_SOFT }}>•</span>{" "}
            Trust
          </p>
          ...
          <div className="flex w-full max-w-xl flex-col items-center">
            <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-center sm:justify-center sm:gap-6">
              ...
              <SwooshToCta className="-mt-2 shrink-0 sm:mt-2 sm:-ml-2 -mb-2 sm:-mb-0" />
            </div>
